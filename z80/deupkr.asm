...
;; Optimized version by Ivan Gorodetsky 2022-12-08
;;
;; 170 bytes forward without UPKR_UNPACK_SPEED
;; 193 bytes forward with UPKR_UNPACK_SPEED
;; 167 bytes backward without UPKR_UNPACK_SPEED
;; 190 bytes backward with UPKR_UNPACK_SPEED
;;
...
#ELSE
    ;;; unrolled MUL for better performance, +23 bytes unpack size
    ld      b,d
	sla h\ ld l,e
